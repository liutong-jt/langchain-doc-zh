...
### Extracting images[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#extracting-images)
...
## Using MathPix[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#using-mathpix)
...
## Using Unstructured[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#using-unstructured)
...
### Retain Elements[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#retain-elements)
...
### Fetching remote PDFs using Unstructured[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#fetching-remote-pdfs-using-unstructured)
...
## Using PyPDFium2[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#using-pypdfium2)
...
## Using PDFMiner[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#using-pdfminer)
...
### Using PDFMiner to generate HTML text[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#using-pdfminer-to-generate-html-text)
...
## Using PyMuPDF[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#using-pymupdf)
...
## PyPDF Directory[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#pypdf-directory)
...
## Using PDFPlumber[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#using-pdfplumber)
...
## Using AmazonTextractPDFParser[](https://python.langchain.com/docs/modules/data_connection/document_loaders/pdf#using-amazontextractpdfparser)
