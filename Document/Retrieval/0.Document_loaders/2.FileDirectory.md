...
## Show a progress bar[](https://python.langchain.com/docs/modules/data_connection/document_loaders/file_directory#show-a-progress-bar)
...
## Use multithreading[](https://python.langchain.com/docs/modules/data_connection/document_loaders/file_directory#use-multithreading)
...
## Change loader class[](https://python.langchain.com/docs/modules/data_connection/document_loaders/file_directory#change-loader-class)
...
## Auto-detect file encodings with TextLoader[](https://python.langchain.com/docs/modules/data_connection/document_loaders/file_directory#auto-detect-file-encodings-with-textloader)
...
### A. Default Behavior[](https://python.langchain.com/docs/modules/data_connection/document_loaders/file_directory#a-default-behavior)
...
### B. Silent fail[](https://python.langchain.com/docs/modules/data_connection/document_loaders/file_directory#b-silent-fail)
...
### C. Auto detect encodings[](https://python.langchain.com/docs/modules/data_connection/document_loaders/file_directory#c-auto-detect-encodings)
